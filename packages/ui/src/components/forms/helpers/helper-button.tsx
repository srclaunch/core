...
export const HelperButton = memo(
  ({ content }: { readonly content: ReactElement }): ReactElement => {
...
`;
const Button = styled.button<{ readonly secondary: boolean }>`
...
const Content = styled.div<{ readonly visible: boolean }>`
  background: white;
