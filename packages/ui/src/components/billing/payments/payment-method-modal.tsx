              ...
              <ReviewOrder>
                {premium && (
                  <Summary>
                    ...
                    in <b>{paymentMethod.lastFourDigits}</b>.
                  </Summary>
                )}
                    ...
                    return (
                      <PaymentMethodItem key={pm.id}>
                        ...
                        <Brand>
                          <img
                            alt={pm.brand}
                            src={`/stripe_networks/${pm.brand}.svg`}
                          />
                          <span>
                            {pm.brand} ending in {pm.lastFourDigits}
                          </span>
                        </Brand>
                        <Expiry>
                          Expires{' '}
                          <span>
                            {pm.expirationMonth}/{pm.expirationYear}
                          </span>
                        </Expiry>
                      </PaymentMethodItem>
                    );
