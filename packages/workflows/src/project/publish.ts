...
//           name: '${{ github.event.repository.owner.login }}-${{ github.event.repository.name }}
//-${{ needs.get-metadata.outputs.branch }}-${{ needs.get-metadata.outputs.version }}-build',
//           paths: [
//             'dist',
//             'package.json',
//             'README.md',
...
//${{ github.event.repository.name }}-${{ needs.env-vars.outputs.branch }}-code-coverage.json',
...
//           name: '${{ github.event.repository.owner.login }}-
//${{ github.event.repository.name }}-${{ needs.get-metadata.outputs.branch }}-
//${{ needs.get-metadata.outputs.version }}-build',
//         }),
//         new SetupNode({
//           cache: 'yarn',
//           nodeVersion: '16.x',
